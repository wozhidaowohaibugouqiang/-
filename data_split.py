...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.75, val_scale=0.2, test_scale=0.05):
    '''
...
if __name__ == '__main__':
    src_data_folder = "C:/Users/Lenovo/Desktop/test2"   # todo 修改你的原始数据集路径
    target_data_folder = "C:/Users/Lenovo/Desktop/shucaishibie/vegetables_tf2.3-master/new_data2"  # todo 修改为你要存放的路径
