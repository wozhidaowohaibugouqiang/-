...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load("C:/Users/Lenovo/Desktop/shucaishibie/vegetables_tf2.3-master/new_date/train",
                                              "C:/Users/Lenovo/Desktop/shucaishibie/vegetables_tf2.3-master/new_date/val", 224, 224, 16)
    print(class_names)
    # 加载模型
    ...
    model.save("models/cnn_vegetables002.h5")
    # 记录结束时间
    end_time = time()
