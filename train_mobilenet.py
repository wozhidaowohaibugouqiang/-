...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load(r"C:\Users\Lenovo\Desktop\shucaishibie\vegetables_tf2.3-master\new_data2\train",
                                              r"C:\Users\Lenovo\Desktop\shucaishibie\vegetables_tf2.3-master\new_data2\val", 224, 224, 16)
    print(class_names)
    # 加载模型
    ...
    model.save("models/vg2_mobilenet_fv.h5")
    # 记录结束时间
    end_time = time()
