...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('蔬菜识别系统')  # todo 修改系统名称
        # 模型初始化
        self.model = tf.keras.models.load_model("models/vg2_mobilenet_fv.h5")  # todo 修改模型名称
        self.to_predict_name = "images/tim9.jpeg"  # todo 修改初始图片，这个图片要放在images目录下
        self.class_names = ['儿菜','生菜','茼蒿','香菜','小白菜','小青菜','油麦菜']  # todo 修改类名，这个数组在模型训练的开始会输出
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        label_super = QLabel("作者：chenyi")  # todo 更换作者信息
